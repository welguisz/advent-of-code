...
public class ManyWorldsInterpretation extends AoCDay {
    ...
    public void solve() {
        List<String> lines = readFile("/Users/dwelguisz/personal/advent-of-code/src/resources/year2019/day18/input.txt");
        Long parseTime = Instant.now().toEpochMilli();
        startingPoint = parseLines(lines);
        Long startTime = Instant.now().toEpochMilli();
        Integer part1 = solutionPart1(startingPoint);
        Long part1Time = Instant.now().toEpochMilli();
        Integer part2 = solutionPart2(startingPoint);
