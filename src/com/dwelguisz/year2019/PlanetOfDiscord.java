...
public class PlanetOfDiscord extends AoCDay {
    public void solve() {
        ...
        List<String> lines = readFile("/Users/dwelguisz/personal/advent-of-code/src/resources/year2019/day24/input.txt");
        Set<Coord2D> initialState = getInitialState(lines);
        Long startTime = Instant.now().toEpochMilli();
        Long part1 = solutionPart1(initialState);
        Long part1Time = Instant.now().toEpochMilli();
        Integer part2 = solutionPart2(getInitialState(lines));
